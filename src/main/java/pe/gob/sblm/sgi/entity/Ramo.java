 ...
 */
@Entity
@Table(name = "RAMO", schema = "dbo", catalog = "sisinmueble")
public class Ramo implements java.io.Serializable {
	...
	public Ramo(int idramo) {
		this.idramo = idramo;
	}

	public Ramo(int idramo, String descripcion, String usrcre, String usrmod,
	...
	@Id @GeneratedValue
	@Column(name = "idramo", unique = true, nullable = false)
